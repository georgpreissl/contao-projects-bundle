...
class AjaxListener implements FrameworkAwareInterface
{
    ...
    {
        if ('reloadProjectCategoriesWidget' === $action) {
            $this->reloadProjectCategoriesWidget($dc);
        }
    }

    /**
     * Reload the project categories widget.
     *
     * @param DataContainer $dc
     */
    private function reloadProjectCategoriesWidget(DataContainer $dc)
    {
        /**
         * @var Database
         * @var Input    $input
        ...
        /** @var ProjectCategoriesPickerWidget $strClass */
        $strClass = $GLOBALS['BE_FFL']['projectCategoriesPicker'];

        /** @var ProjectCategoriesPickerWidget $objWidget */
